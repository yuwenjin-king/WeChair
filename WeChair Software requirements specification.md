...
##2.2产品功能
###2.2.1活动图
![](https://img2020.cnblogs.com/blog/1930017/202003/1930017-20200329163139003-73249814.png)
###2.2.2类图
![](https://img2020.cnblogs.com/blog/1930017/202003/1930017-20200329163201545-129340381.png)
##2.2.3主要功能说明
...
5|自动下座|L3|高|系统会根据手机定位判定用户是否离开座
位6|学习时长排行|L3|中|对用户学习时长进行每日每周排行
##2.3用户特点
###2.3.1用户群体
- 自主学习能力
- 组队学习人群
...
##2.4一般约束
项目开发经验约束:组员都是大三的在校生，缺乏项目开发实战经验，所以此次是一个边学边做的过程
...
安全和保密考虑:对于用户信息的存储保护，对于数据库结构合理性和安全性需要严谨的考虑

##2.5假设和依赖
用户配合:假设小程序开发过程中，投放的问卷等调查能得到大量目标潜在用户的积极响应，并且调查结果具有真实性、普遍性和可靠性
